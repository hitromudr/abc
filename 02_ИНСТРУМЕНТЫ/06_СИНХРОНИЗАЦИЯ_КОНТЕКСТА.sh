...
# Точка входа для агента (Process Helix v3).
...
echo "PROCESS HELIX: Автоматическое сканирование дерева (v3). Ручной массив упразднён."
echo "--------------------------------------------------------------------------------"

# --- ЯДРО (обязательная загрузка) ---
# .rules + 00_ИНИЦИАЛИЗАЦИЯ + 01_БАЗА_ЗНАНИЙ + 02_ИНСТРУМЕНТЫ
CORE_PATHS=()
