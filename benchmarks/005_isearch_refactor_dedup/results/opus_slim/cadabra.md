...
Status: done. 4 файла затронуты: 1 создан (`src/file_utils.py`), 3 модифицированы (`src/services.py`, `src/graph_builder.py`, `src/index.py`). Дублированная логика gitignore (3→1) и file type classification (2→1) консолидирована.