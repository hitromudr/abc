...
abracadabra разделяет роли: **abra** (архитектор) создаёт план с ограничениями (DAG + Kill Box + retry budget), **cadabra** (исполнитель) методично итерирует по плану.

Bench 005 (refactor, 19 тестов) — 5 моделей, все через cadabra:

| Модель | Cost | Time | Tests |
|--------|-----:|-----:|:-----:|
| DeepSeek-chat | **$0.009** | 330s | ✅ 19/19 |
| Gemini 2.5 Flash | $0.14 | 200s | ✅ 19/19 |
| Gemini 2.5 Pro | $0.19 | 120s | ✅ 19/19 |
| Sonnet | $0.54 | 161s | ✅ 19/19 |
| Opus | $0.67 | 128s | ✅ 19/19 |

DeepSeek за $0.009 решает задачу, которую Opus baseline решает за $0.79. 88× дешевле.
